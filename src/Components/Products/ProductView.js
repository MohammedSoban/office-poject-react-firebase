...
stackable>
    ...
    <Grid.Row centered={true}> 
     ...
     <div> <Rating icon='star' defaultRating={this.state.overAllRating} maxRating={5} disabled={true}/> ({this.state.productRatings.length})</div>
      <br/>
...
<br/>
        ...
        {/* <div>{ console.log(!this.state.isUserLoggedin,'!')} {console.log(!this.state.alreadyRated,'!')} { console.log(this.state.isUserLoggedin)} {console.log(this.state.alreadyRated)}</div> */}
                  ...
                  {this.state.alreadyRated?(<div><Rating icon='star' defaultRating={this.state.userRated} maxRating={5} disabled={true}/> </div> ):( <Rating icon='star' defaultRating={0} maxRating={5} rating={this.state.rating}  clearable={false} disabled={!this.state.isUserLoggedin} onRate={(event,data)=>this.handleOnRating(event,data.rating)} />)}
